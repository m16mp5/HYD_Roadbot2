...
class MyMainWindow(QMainWindow):
    ...
    filename = os.path.join("/home", os.environ["USER"], "poc", "trimmer.yaml")
    ...
    def cali_task(self):
        ...
        p0 = np.array([ 0.351986780000, -0.899605440000,  0.908954460000])
    ...
    def write_yaml(self):
        ...
        filename = os.path.join(path, "trimmer.yaml")
    ...
    def set_tool(self):
        ...
        if self.use_tool2 == True:
          ...
          self.trimmer_default_pose.A =  -30
          self.trimmer_default_pose.B =  180
          self.trimmer_default_pose.C =    0
          self.trimmer_default_pose.X = 1420
          self.trimmer_default_pose.Y = -350
          self.trimmer_default_pose.Z = 1100
        return res
